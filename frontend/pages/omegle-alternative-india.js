    ...
    <div className="landing-wrap">
      ...
      <div className="landing-inner">
        ...
        <section className="hero">
          <div className="badge">🇮🇳 THE PREMIER INDIAN CONNECTION</div>
          <h1>
            The Leading<br />
            <span>Omegle Alternative in India.</span>
          </h1>
          <p className="hero-sub">
            Say goodbye to unsafe and spammy random video chats. Welcome to ZoneMeet — a secure, AI-moderated, 
            and modern web platform designed to help you <strong>talk to strangers online in India</strong> and enjoy 
            premium <strong>random video chat in India</strong>. Meet real people and make lasting global friends 
            in a safe digital environment.
          </p>
          <div className="hero-btns">
            <Link href="/" className="btn-primary">
              Start Indian Video Chat Now
            </Link>
          </div>
        </section>
        ...
        <section className="features-grid">
          <div className="feat-card">
            ...
            <h3>Seamless WebRTC Calling</h3>
            <p>Experience crystal-clear, high-definition <strong>indian video chat</strong> with our advanced peer-to-peer technology. Low latency, no delays, and crystal-clear sound, optimized even on mobile networks.</p>
          </div>
          <div className="feat-card">
            <div className="feat-icon">🛡️</div>
            <h3>Smart AI-Guardian Moderation</h3>
            <p>Our real-time AI filters analyze reports and monitor streams to block spam, bots, and offensive behavior. Relax in a secure online environment built for respectful users.</p>
          </div>
          <div className="feat-card">
            <div className="feat-icon">🌍</div>
            <h3>Global & Regional Filters</h3>
            <p>Easily customize your matching preferences. Meet someone next door or cross borders to chat with strangers from over 190 countries worldwide.</p>
          </div>
        </section>
        ...
        <section className="compare-section">
          <div className="section-header">
            <h2>The Perfect Omegle Alternative India Deserves</h2>
            <p>Omegle has gone, but the thrill of meeting people remains. Here is why ZoneMeet is the superior next-generation platform.</p>
          </div>
          <div className="compare-grid">
            <div className="compare-card">
              <span className="bullet">🇮🇳</span>
              <div>
                <strong>Designed for Indian Users</strong>
                <p>Enjoy local server optimization and seamless matching with peers nearby. It is the best <strong>indian video chat</strong> experience with lightning-fast speeds.</p>
              </div>
            </div>
            <div className="compare-card">
              <span className="bullet">🔒</span>
              <div>
                ...
                <p>Your connections are direct and fully encrypted. We do not store log transcripts or stream logs on our backend, preserving your digital confidentiality.</p>
              </div>
            </div>
            <div className="compare-card">
              <span className="bullet">🤖</span>
              <div>
                <strong>Zero Fake Accounts & Spambots</strong>
                <p>We require secure authentication models (such as Google Sign-In) to verify active accounts and actively prevent automated bots from ruining your stream.</p>
              </div>
            </div>
            <div className="compare-card">
              <span className="bullet">💬</span>
              <div>
                <strong>Add Friends & Keep in Touch</strong>
                <p>Liked someone you met during a random match? Add them to your global circle and continue your conversation with free direct video calls later.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="steps-section">
          <div className="section-header">
            <h2>How to Talk to Strangers Online in India</h2>
            <p>Start your first <strong>random video chat india</strong> experience in three effortless steps.</p>
          </div>
          <div className="steps-container">
            <div className="step">
              <span className="num">1</span>
              <h4>Quick and Secure Register</h4>
              <p>Sign up securely with your Google account or email. It takes less than 10 seconds to create your secure profile.</p>
            </div>
            <div className="step-arrow">→</div>
            <div className="step">
              <span className="num">2</span>
              <h4>Set Match Parameters</h4>
              <p>Filter by language, region, or gender settings to customize your matches and connect with relevant peers.</p>
            </div>
            <div className="step-arrow">→</div>
            <div className="step">
              <span className="num">3</span>
              <h4>Tap "Connect Now"</h4>
              <p>Instantly launch a direct, secure connection. Swap to the next match with a single tap if you wish to skip.</p>
            </div>
          </div>
        </section>
        ...
        <section className="safety-section">
          <div className="safety-box">
            <div className="safety-title">
              <span>🔞</span>
              <h2>Strictly 18+ Safe and Respectful Indian Community</h2>
            </div>
            <p>
              ZoneMeet is dedicated to fostering a friendly, respectful, and adult-friendly environment. Our random video chat in India is strictly limited to users aged 18 and older. We enforce a zero-tolerance policy against nudity, harassment, commercial spam, and hate speech. Violations lead to immediate, permanent hardware and IP-level bans. Please help us maintain a friendly community by using our rapid-report buttons.
            </p>
          </div>
        </section>
        ...
        <section className="faq-section">
          <div className="section-header">
            ...
            <p>Everything you need to know about using ZoneMeet as your go-to Indian video chat platform.</p>
          </div>
          <div className="faq-list">
            <div className="faq-item">
              <h3>Is ZoneMeet the best Omegle alternative India has to offer?</h3>
              <p>Yes, absolutely! Unlike classic video chats that are plagued with spam, bots, and security vulnerabilities, ZoneMeet integrates real-time AI moderation, reliable end-to-end encryption, and a robust friend system to provide the safest and most modern Omegle alternative in India.</p>
            </div>
            <div className="faq-item">
              <h3>Is it free to talk to strangers online in India here?</h3>
              <p>Yes, matching and text chatting are free. We also offer daily bonuses and streak multipliers, allowing active community members to unlock advanced filters and personalization for free.</p>
            </div>
            <div className="faq-item">
              <h3>Is my personal data safe on Indian video chat rooms?</h3>
              <p>Your privacy is our number one priority. All audio and video streams are routed peer-to-peer (P2P) using WebRTC, which is fully encrypted. ZoneMeet does not record, store, or monitor your private communications, keeping you entirely safe.</p>
            </div>
            <div className="faq-item">
              <h3>Do I need to download an Android or iOS application?</h3>
              <p>No app store downloads are required! ZoneMeet is a fully mobile-responsive web application that runs directly inside your default mobile or desktop browser (Safari, Chrome, Firefox, etc.) with extreme smoothness.</p>
            </div>
          </div>
        </section>
        ...
        <section className="cta-bottom">
          <h2>Ready to experience the ultimate Omegle alternative India?</h2>
          <p>Join thousands of active users online from Delhi, Mumbai, Bangalore, and across the globe. Click below to start chatting now!</p>
